...
export const initials = [{ name: "Mr" }, { name: "Mrs" }, { name: "Ms" }];
export const Individualhectres = [
  { name: 1 },
  { name: 2 },
  { name: 3 },
  { name: 4 },
...
export const plan = [
  { name: "Cropping" },
  { name: "Livestock" },
  { name: "Cropping & Livestock" },
  { name: "Agro-Industry" },
  { name: "Others" },
];
export const checks = [{ name: "Yes" }, { name: "No" }];
export const OgunLGA = [
  {
    name: "Abeokuta South",
    id: 1,
  },
